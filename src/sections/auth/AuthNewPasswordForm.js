...
export default function AuthNewPasswordForm() {
  ...
  const VerifyCodeSchema = Yup.object().shape({
    code1: Yup.string().required('Коде обязателен'),
    code2: Yup.string().required('Коде обязателен'),
    code3: Yup.string().required('Коде обязателен'),
    code4: Yup.string().required('Коде обязателен'),
    code5: Yup.string().required('Коде обязателен'),
    code6: Yup.string().required('Коде обязателен'),
  ...
  const onSubmit = async (data) => {
    try {
      ...
      enqueueSnackbar('Смена пароля прошла успешно!');
